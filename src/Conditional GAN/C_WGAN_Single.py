...
data_root = f'{args.data_root}/class_seperated/'

# Result directory
result_root = '/project/def-gargoum/afshinsh/Data-Generation/Conditional GAN/results/C_WGAN/'
